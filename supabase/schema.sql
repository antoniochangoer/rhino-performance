...
-- Allow reading username/email of other users (needed for share flows)
...
-- ============================================================
-- Run these in Supabase SQL editor to migrate existing databases
-- ============================================================
...
-- Drop old restrictive profile policy and replace with public read
